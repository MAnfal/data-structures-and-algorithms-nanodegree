...
print(intersection(linked_list_3, linked_list_4)) # No intersection found.

# Additional test cases
llist_5 = convert_list_linked_list([])
llist_6 = convert_list_linked_list([1, 7, 8, 9, 11, 21, 1])

print(union(llist_5, llist_6)) # 1 -> 7 -> 8 -> 9 -> 11 -> 21 ->
print(intersection(llist_5, llist_6)) # No intersection found.

llist_7 = convert_list_linked_list([1, 1, 1, 2, 2, 2, 3, 3, 3])
llist_8 = convert_list_linked_list([3, 3, 1, 1, 2, 2])

print(union(llist_7, llist_8)) # 1 -> 2 -> 3 ->
print(intersection(llist_7, llist_8)) # 1 -> 2 -> 3 -> 
