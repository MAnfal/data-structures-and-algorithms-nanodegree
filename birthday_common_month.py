...
def get_most_common_month(people):
    ...
    for month_name in months:
        if month_with_most_birthdays['name'] is None or month_with_most_birthdays['birthday_count'] < months[month_name]:
            month_with_most_birthdays['name'] = month_name
            month_with_most_birthdays['birthday_count'] = months[month_name]

    return month_with_most_birthdays['name']
